...
// END OF DAY
//
// 1 December means active until 1 December 11:59:59 PM.
// 2 December means expired.
// ============================================================
...
function getSubscriptionCreatedDate(
    sub
) {
...
// ============================================================
// SELECT BEST ACTIVE SUBSCRIPTION
// ============================================================
        ...
        if (userSnap.exists()) {
            ...
            if (
                ...
                try {
                    ...
                    console.warn(
                        'Could not update user subscription status:',
                        error
                    );
                }
            }
